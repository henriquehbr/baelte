...
const componentGeneratorActions = ({ name, packageManager, bundler } = {}) => {
    ...
    const devDependenciesToInstall = bundler === 'rollup'
        ? [
            'cross-env',
            '@rollup/plugin-alias',
...
exports.componentGeneratorActions = componentGeneratorActions;
